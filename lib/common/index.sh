...
KC_ASDF_NAME="asdf-golang"
KC_ASDF_REPO="https://github.com/kc-workspace/asdf-golang"
export KC_ASDF_ORG KC_ASDF_NAME KC_ASDF_REPO

## Application information
KC_ASDF_APP_TYPE="standalone"
KC_ASDF_APP_NAME="go"
KC_ASDF_APP_WEBS="https://go.dev/"
KC_ASDF_APP_DESC="An open-source programming language supported by Google"
KC_ASDF_APP_CMDS="
- test    - test if cli exist and executable
- version - print *plugin* version
"
KC_ASDF_APP_REPO="https://github.com/golang/go"
